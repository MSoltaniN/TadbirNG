...
{
    [TestFixture]
    public class CostCenterValidatorTests : TestBase
    {
        ...
        {
            _validator = new CostCenterValidator(GetStringLocalizer());
            ReadEditionsConfig();
        }
        ...
        {
            // Arrange
            var model = new CostCenterViewModel() { Level = (short)_editions.Standard.MaxCostCenterDepth };
        ...
        {
            // Arrange
            var model = new CostCenterViewModel() { Level = (short)(_editions.Standard.MaxCostCenterDepth - 1) };
        ...
        {
            // Arrange
            var model = new CostCenterViewModel() { Level = (short)_editions.Professional.MaxCostCenterDepth };
        ...
        {
            // Arrange
            var model = new CostCenterViewModel() { Level = (short)(_editions.Professional.MaxCostCenterDepth - 1) };
        ...
        {
            // Arrange
            var model = new CostCenterViewModel() { Level = AppConstants.MaxAccountTreeLevel };
        ...
        {
            // Arrange
            var model = new CostCenterViewModel() { Level = AppConstants.MaxAccountTreeLevel - 1 };
        ...
        private CostCenterValidator _validator;
