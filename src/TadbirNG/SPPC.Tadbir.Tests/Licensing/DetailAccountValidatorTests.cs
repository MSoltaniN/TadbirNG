...
{
    [TestFixture]
    public class DetailAccountValidatorTests : TestBase
    {
        ...
        {
            _validator = new DetailAccountValidator(GetStringLocalizer());
            ReadEditionsConfig();
        }
        ...
        {
            // Arrange
            var model = new DetailAccountViewModel() { Level = (short)_editions.Standard.MaxDetailAccountDepth };
        ...
        {
            // Arrange
            var model = new DetailAccountViewModel() { Level = (short)(_editions.Standard.MaxDetailAccountDepth - 1) };
        ...
        {
            // Arrange
            var model = new DetailAccountViewModel() { Level = (short)_editions.Professional.MaxDetailAccountDepth };
        ...
        {
            // Arrange
            var model = new DetailAccountViewModel() { Level = (short)(_editions.Professional.MaxDetailAccountDepth - 1) };
        ...
        {
            // Arrange
            var model = new DetailAccountViewModel() { Level = AppConstants.MaxAccountTreeLevel };
        ...
        {
            // Arrange
            var model = new DetailAccountViewModel() { Level = AppConstants.MaxAccountTreeLevel - 1 };
        ...
        private DetailAccountValidator _validator;
