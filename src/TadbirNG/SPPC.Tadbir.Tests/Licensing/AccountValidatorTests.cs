...
{
    [TestFixture]
    public class AccountValidatorTests : TestBase
    {
        ...
        {
            _validator = new AccountValidator(GetStringLocalizer());
            ReadEditionsConfig();
        }
        ...
        {
            // Arrange
            var model = new AccountViewModel() { Level = (short)_editions.Standard.MaxAccountDepth };
        ...
        {
            // Arrange
            var model = new AccountViewModel() { Level = (short)(_editions.Standard.MaxAccountDepth - 1) };
        ...
        {
            // Arrange
            var model = new AccountViewModel() { Level = (short)_editions.Professional.MaxAccountDepth };
        ...
        {
            // Arrange
            var model = new AccountViewModel() { Level = (short)(_editions.Professional.MaxAccountDepth - 1) };
        ...
        {
            // Arrange
            var model = new AccountViewModel() { Level = AppConstants.MaxAccountTreeLevel };
        ...
        {
            // Arrange
            var model = new AccountViewModel() { Level = AppConstants.MaxAccountTreeLevel - 1 };
