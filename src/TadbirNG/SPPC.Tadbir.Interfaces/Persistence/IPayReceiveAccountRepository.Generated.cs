...
namespace SPPC.Tadbir.Persistence
{
    ...
    public interface IPayReceiveAccountRepository
    {
        ...
        Task<PayReceiveAccountViewModel> SaveAccountArticleAsync(PayReceiveAccountViewModel payreceiveaccount);
        ...
        Task DeleteAccountArticleAsync(int accountArticleId);
        ...
        Task DeleteAccountArticlesAsync(IList<int> accountArticleIds);
