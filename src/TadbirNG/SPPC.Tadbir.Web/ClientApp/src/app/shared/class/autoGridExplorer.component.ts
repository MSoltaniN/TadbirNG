import { Injectable, ViewChild, Renderer2, Optional, Inject, ChangeDetectorRef, NgZone, OnInit, ElementRef } from "@angular/core";
...
export class AutoGridExplorerComponent<T> extends AutoGeneratedGridComponent implements OnInit {
  ...
  constructor(public toastrService: ToastrService, public translate: TranslateService, public service: GridService, public dialogService: DialogService,
    ...
    @Optional() @Inject('empty') public entity: string, @Optional() @Inject('empty') public parentTitlekey: string,
    ...
    @Optional() @Inject(ErrorHandlingService) public errorHandlingService?: ErrorHandlingService) {
    super(toastrService, translate, service, renderer, metadata, settingService, bStorageService, cdref, ngZone,elem);
