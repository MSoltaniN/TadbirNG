...
import { BrowserStorageService, DashboardService, GridService, LookupService, MetaDataService, ReportingService,AdvanceFilterService,LicenseService } from '@sppc/shared/services/index';
...
import {
  ...
  SppcViewTreeConfig,InputDirective
...
export class SharedModule {
  static forRoot(): ModuleWithProviders { 
    ...
    return {
      ...
      providers: [BrowserStorageService, DashboardService, GridService, LookupService, MetaDataService, ReportingService, AdvanceFilterService,LicenseService,
        { provide: MessageService, useClass: GridMessageService },
        MetaDataResolver, DefaultComponent, AutoGeneratedGridComponent, GridExplorerComponent,
        DatePipe, ShortcutService, ShareDataService,MessageBoxService
      ]
    };
  }
}
