...
import { AutoGeneratedGridComponent, Filter, FilterExpression, String } from '@sppc/shared/class';
...
@Component({
  selector: 'user-value-list',
  templateUrl: './user-value-list.component.html',
  styleUrls: ['./user-value-list.component.css']
})
export class UserValueListComponent extends AutoGeneratedGridComponent implements OnInit {
