import { Component, OnInit, Renderer2, ChangeDetectorRef, NgZone, Input, ElementRef  } from '@angular/core';
...
export class UserComponent extends AutoGeneratedGridComponent implements OnInit {
  ...
  public saveUser(model: User) {
    ...
    var serviceUrl = this.isNew ? UserApi.Users : String.Format(UserApi.User, model.id);
