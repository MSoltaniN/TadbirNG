import { Component, OnInit, Renderer2, ChangeDetectorRef, NgZone, Input, ViewChild, ElementRef, OnDestroy } from '@angular/core';
...
export class currencyRateComponent extends AutoGeneratedGridComponent<CurrencyRateInfo> implements OnInit,OnDestroy {
  scopes = ["currencyRateComponent","AutoGeneratedGridComponent"];
  ...
  openEditorDialog(isNew: boolean) {
    ...
    this.dialogRef = this.dialogService.open({
      title: this.getText(isNew ? 'CurrencyRate.New' : 'CurrencyRate.Edit'),
    ...
    this.dialogRef.content.instance.save.subscribe(async (model) => {      
      ...
      await this.saveHandler(model, isNew, this.currencyService, serviceUrl);
      setTimeout(() => {
        this.highLightNewRow(model.time)
      }, 100);
    });
