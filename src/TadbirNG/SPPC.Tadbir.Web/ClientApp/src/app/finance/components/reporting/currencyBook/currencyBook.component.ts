...
export class CurrencyBookComponent extends AutoGeneratedGridComponent implements OnInit, OnDestroy {
  ...
  getCurrencies() {
    this.lookupService.GetCurrenciesLookup().subscribe(res => {
      this.currenciesRows.push({ key: "0", value: this.getText('CurrencyBook.AllCurrencies') });
  ...
  isEnableVoucherInfoBtn = () => {
    ...
    if (this.selectedRows.length == 1 &&
      (this.displayTypeSelected == BookDisplayType.ByRow.toString() || this.displayTypeSelected == BookDisplayType.VoucherSum.toString()))
      return false;
    else
      return true;
  }
