...
import { CostCenterApi, CurrencyApi } from '@sppc/finance/service/api';
...
export class CurrencyComponent extends AutoGeneratedGridComponent<Currency> implements OnInit,OnDestroy {

  scopes = ["CurrencyComponent","AutoGridExplorerComponent"];
  ...
  openEditorDialog(isNew: boolean) {
    ...
    this.dialogRef = this.dialogService.open({
      title: this.getText(isNew ? 'Currency.New' : 'Currency.Edit'),
  ...
  updateActiveState(toActivate:boolean) {
    let URL = toActivate == true? CurrencyApi.ReactivateCurrency: CurrencyApi.DeactivateCurrency;
