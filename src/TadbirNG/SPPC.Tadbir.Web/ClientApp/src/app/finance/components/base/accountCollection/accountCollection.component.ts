...
export class AccountCollectionComponent extends AutoGeneratedGridComponent implements OnInit {
  ...
  */
  public selectedRowData: Array<AccountCollectionAccount> = [];
  ...
  constructor(public toastrService: ToastrService, public translate: TranslateService, public dialogService: DialogService, public gridService: GridService,
    ...
    public settingService: SettingService, public bStorageService: BrowserStorageService, public ngZone: NgZone,public elem:ElementRef) {
  ...
  addAccount() {    
    if (this.isSelectableAccount()) {
      if (!this.selectedRowData.find(f => f.accountId == this.selectableRowsKey[0])) {
        var row: AccountInfo = this.rowData.data.find(f => f.id == this.selectableRowsKey[0]);
        ...
        this.selectedRowData.push(accCollection);
