...
export class BalanceByAccountComponent extends AutoGeneratedGridComponent implements OnInit, OnDestroy  {
  ...
  updateBreadCrumb(accountLevelList?:any,selectedAccountLevel?:any,acc?: any):boolean {
    ...
    if(accountLevelList && selectedAccountLevel)
    {
      ...
      //         data.displayType = 
      //         { 
      //           title : this.getText('BalanceByAccount.AllAccount'),
      //           viewId : ViewName.Account.toString()
      //         }
      //         break
      //       }
      //       case ViewName.DetailAccount.toString(): {
      //         data.displayType = 
      //         { 
      //           title : this.getText('BalanceByAccount.AllDetailAccount'),
      //           viewId : ViewName.DetailAccount.toString()
      //         }
      //         break
      //       }
      //       case ViewName.CostCenter.toString(): {
      //         data.displayType = 
      //         { 
      //           title : this.getText('BalanceByAccount.AllCostCenter'),
      //           viewId : ViewName.CostCenter.toString()
      //         }
      //         break
      //       }
      //       case ViewName.Project.toString(): {
      //         data.displayType = 
      //         { 
      //           title : this.getText('BalanceByAccount.AllProject'),
      //           viewId : ViewName.Project.toString()
      //         }
      //         break
      //       }
      //       default:
      ...
      //     this.displayTypeName = data.displayType.title;
