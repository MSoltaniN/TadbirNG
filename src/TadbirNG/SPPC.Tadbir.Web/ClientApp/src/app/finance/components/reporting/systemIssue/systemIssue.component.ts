import { Component, OnInit, Renderer2, forwardRef, ChangeDetectorRef, NgZone, ViewChild, ElementRef } from '@angular/core';
...
import { Layout, MessageType, Entities } from '@sppc/shared/enum/metadata';
import { BrowserStorageService, MetaDataService, GridService, ErrorHandlingService } from '@sppc/shared/services';
...
export class SystemIssueComponent extends AutoGeneratedGridComponent implements OnInit {
  ...
  constructor(public toastrService: ToastrService, public translate: TranslateService, public dialogService: DialogService, public gridService: GridService,
    ...
    public bStorageService: BrowserStorageService, public settingService: SettingService, public ngZone: NgZone, public errorHandlingService: ErrorHandlingService,public elem:ElementRef) {
  ...
  getReportData() {
    if (this.getDataUrl) {
      ...
      this.getDataUrl = this.getDataUrl + "?from=" + this.fromDate + "&to=" + this.toDate;
      this.reloadGrid();
    }
  }
