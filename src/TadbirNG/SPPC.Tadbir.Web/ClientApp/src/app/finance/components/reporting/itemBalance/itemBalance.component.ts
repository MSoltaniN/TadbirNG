...
//#region Imports
import { Component, OnInit, OnDestroy, ChangeDetectorRef, Renderer2, NgZone, ViewChild, EventEmitter, ElementRef } from '@angular/core';
...
import { AccountInfo, ItemBalanceService, VoucherService } from '@sppc/finance/service';
...
export class ItemBalanceComponent extends AutoGeneratedGridComponent implements OnInit {
  ...
  constructor(public toastrService: ToastrService, public translate: TranslateService, public dialogService: DialogService, public gridService: GridService,
    ...
    , public itemBalanceService: ItemBalanceService, public lookupService: LookupService, public voucherService: VoucherService,public elem:ElementRef) {
  ...
  showAccountBook(selectedAccount) {
    ...
    if (this.itemBalanceType == '1') {
      this.clickedRowItem = selectedAccount ? selectedAccount : this.selectedRows[0];
      if (this.clickedRowItem) {
        this.dialogRef = this.dialogService.open({
        ...
        account.name = this.clickedRowItem.accountName;
        account.id = this.clickedRowItem.accountId;
        account.level = selectedAccount ? this.breadCrumbList[this.breadCrumbList.length - 1].displayType.level - 2 : this.breadCrumbList[this.breadCrumbList.length - 1].displayType.level - 1;
