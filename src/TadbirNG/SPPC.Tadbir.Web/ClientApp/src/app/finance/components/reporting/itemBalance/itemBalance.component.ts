...
//#region Imports
import { Component, OnInit, OnDestroy, ChangeDetectorRef, Renderer2, NgZone, ViewChild, EventEmitter } from '@angular/core';
...
export class ItemBalanceComponent extends AutoGeneratedGridComponent implements OnInit {
  ...
  constructor(public toastrService: ToastrService, public translate: TranslateService, public dialogService: DialogService, public gridService: GridService,
    ...
    , public itemBalanceService: ItemBalanceService, public lookupService: LookupService, public voucherService: VoucherService) {
