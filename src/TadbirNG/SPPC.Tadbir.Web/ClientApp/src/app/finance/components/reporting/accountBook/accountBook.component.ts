...
import { VoucherStatusResource, BranchScopeResource, ArticleTypesResource, ArticleTypesResourceKey } from '@sppc/finance/enum';
...
import { BookDisplayType, BookDisplayTypeResource, BranchScopeType, VoucherStatusType } from '@sppc/finance/enum/shared';
...
export class AccountBookComponent extends AutoGeneratedGridComponent implements OnInit, OnDestroy {
  ...
  displayType: Array<Item> = [
    { value: BookDisplayTypeResource.ByRow, key: BookDisplayType.ByRow.toString() },
    { value: BookDisplayTypeResource.VoucherSum, key: BookDisplayType.VoucherSum.toString() },
    { value: BookDisplayTypeResource.DailySum, key: BookDisplayType.DailySum.toString() },
    { value: BookDisplayTypeResource.MonthlySum, key: BookDisplayType.MonthlySum.toString() }
  ]
  ...
  constructor(public toastrService: ToastrService, public translate: TranslateService, public dialogService: DialogService, public gridService: GridService,
    ...
    public settingService: SettingService, public reporingService: ReportingService, public ngZone: NgZone, public formBuilder: FormBuilder, public bStorageService: BrowserStorageService,public elem:ElementRef) {
  ...
  isEnableVoucherInfoBtn = () => {
    if (this.selectedRows.length == 1 && (this.displayTypeSelected == BookDisplayType.ByRow.toString() || this.displayTypeSelected == BookDisplayType.VoucherSum.toString()))
      return false;
    else
      return true;
  }
  ...
  rowDoubleClickHandler() {
    if (this.clickedRowItem) {
      ...
      if (this.displayTypeSelected == BookDisplayType.ByRow.toString() || this.displayTypeSelected == BookDisplayType.VoucherSum.toString()) {
