  ...
  */
  ...
  openEditorDialog(isNew: boolean) {
    this.dialogRef = this.dialogService.open({
      title: String.Format(this.getText(isNew ? "Form.New" : "Form.Edit"),this.getText("Entity.PayReceiveAccount")),
  ...
  onAdvanceFilterOk(): any {
    ...
    this.operationId = TreasuryOperationId.FilterAccountLines;
    this.reloadGrid();
  }
  ...
  public allData = (): Observable<any> => {
    ...
    return this.getExportData(TreasuryOperationId.ExportAccountLines);
  };
