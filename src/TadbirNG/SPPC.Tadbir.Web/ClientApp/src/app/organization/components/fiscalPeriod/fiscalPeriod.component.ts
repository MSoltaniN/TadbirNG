import { Component, OnInit, Input, Renderer2, ChangeDetectorRef, NgZone, ViewChild, ElementRef } from '@angular/core';
...
export class FiscalPeriodComponent extends AutoGeneratedGridComponent implements OnInit {
  ...
  constructor(public toastrService: ToastrService, public translate: TranslateService, public gridService: GridService, public bStorageService: BrowserStorageService,
    ...
    public settingService: SettingService, public ngZone: NgZone, public dialogService: DialogService,public shareDataService:ShareDataService,public elem:ElementRef) {
    super(toastrService, translate, gridService, renderer, metadata, settingService, bStorageService, cdref, ngZone,elem, FiscalPeriodApi.FiscalPeriods, FiscalPeriodApi.FiscalPeriod);
  }
...
*/
  ...
  onChangeFiscalPeriod() {
    ...
    if (branchId) {
      ...
      this.showMessage(this.getText("AllValidations.Login.PleaseSelectBranch"), MessageType.Info);
    }
