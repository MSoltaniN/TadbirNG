...
{
    /// <summary>
    /// اطلاعات نمایشی یکی از شرکای تجاری یا کاری در سازمان را نشان میدهد
    /// </summary>
    public partial class BusinessPartnerViewModel
    {
        ...
        /// <summary>
        /// شماره تلفن ثابت ثبت شده برای تماس با شریک تجاری
        /// </summary>
        [MaxLength(64, ErrorMessage = "{0} must have at most {1} characters.")]
        public string Phone { get; set; }

        /// <summary>
        /// آدرس پست الکترونیکی (ایمیل) شریک تجاری
        /// </summary>
        [MaxLength(64, ErrorMessage = "{0} must have at most {1} characters.")]
        public string Email { get; set; }

        /// <summary>
        /// کد اقتصادی شریک تجاری
        /// </summary>
        [MaxLength(64, ErrorMessage = "{0} must have at most {1} characters.")]
        public string CommerceCode { get; set; }

        /// <summary>
        /// آدرس ثبت شده برای شریک تجاری
        /// </summary>
