...
export class QuickReportSettingComponent extends AutoGeneratedGridComponent  {
  ...
  showPaperSetting() {
    ...
    if (this.viewInfo.pageSetting) {
      this.dialogModel.pageSizeSelected = this.viewInfo.pageSetting.pageSize;
      this.dialogModel.pageOrientationSelected = this.viewInfo.pageSetting.pageOrientation;
    }
