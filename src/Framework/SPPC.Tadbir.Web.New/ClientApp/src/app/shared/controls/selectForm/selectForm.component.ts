...
import { String,AutoGeneratedGridComponent, FilterExpression, QuickSearchConfig, MetaDataService, BrowserStorageService, LookupApi, ViewName, Filter, FilterExpressionOperator } from '@sppc/shared';
