...
import { BrowserStorageService, DashboardService, GridService, LookupService, MetaDataService, ReportingService, SppcMessageService } from '@sppc/shared/services/index';
...
@NgModule({
  ...
  exports: [CommonModule,LayoutComponent, SppcGridColumn, SppcAutoGridColumn, SppcGridReorder, SppcAutoGeneratedGridReorder, SppcAutoGeneratedGridResize, SppcGridResize, SppcCheckAccess,
    ...
    PopupModule, TreeViewModule, ContextMenuModule, LayoutModule, ToastrModule, DpDatePickerModule, TranslateModule, DashboardComponent, NavMenuComponent]
})
