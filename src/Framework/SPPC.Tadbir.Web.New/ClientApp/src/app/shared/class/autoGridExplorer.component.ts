 ...
 */
  ...
  reloadGrid(insertedModel?: any) {
    ...
    this.service.getAll(this.getDataUrl, this.pageIndex, this.pageSize, this.sort, filter, undefined, this.listChanged).subscribe((res) => {
  ...
  public getExportData(): Observable<GridDataResult> {
    if (this.getDataUrl) {     
      ...
      return this.service.getAll(this.getDataUrl, 1, 1000000, this.sort, filter, filterExp, false).pipe(
