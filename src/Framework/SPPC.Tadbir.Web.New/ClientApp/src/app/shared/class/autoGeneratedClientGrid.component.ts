...
import { filterBy,SortDescriptor, CompositeFilterDescriptor, orderBy } from "@progress/kendo-data-query";
...
@Injectable()
export class AutoGeneratedClientGridComponent extends DefaultComponent implements OnDestroy {
  ...
  private baseReload() {
    ...
    if (this.currentFilter)
      rows = filterBy(this.rowData, this.currentFilter);

    if (this.sort)
      rows = orderBy(this.rowData, this.sort);
