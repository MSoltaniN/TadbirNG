import { Injectable, ViewChild, Renderer2, Optional, Inject, ChangeDetectorRef, NgZone, EventEmitter, Output, OnDestroy, ReflectiveInjector, DebugElement, ViewContainerRef, Host, HostListener, ViewChildren } from "@angular/core";
...
export class AutoGeneratedGridComponent<T = void | any> extends ListComponent implements OnDestroy {
  ...
  public getExportData(): Observable<GridDataResult> {
    ...
    if (this.getDataUrl) {
      ...
      {
        return this.gridService.getAll(this.getDataUrl, 1, 1000000, this.sort, filter, filterExp, false, OperationId.Export).pipe(
        ...
        return this.gridService.getAllByParams(this.getDataUrl, param, 1, 1000000, this.sort, filter, filterExp, false, OperationId.Export).pipe(
          map(response => (<GridDataResult>{
