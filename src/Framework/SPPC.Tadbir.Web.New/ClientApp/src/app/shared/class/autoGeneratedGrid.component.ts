...
export class AutoGeneratedGridComponent extends DefaultComponent implements OnDestroy {
  ...
  /** این فلگ برای زمانی میباشید که میخواهیم فیلتر رو در کامپوننت مربوطه بسازیم و کلاس بیس این کار را انجام ندهد */
  public ignoreFilterExpression: boolean = false;
  ...
  reloadGrid(insertedModel?: any) {
    if (this.getDataUrl) {
      ...
      if (this.defaultFilter && !this.ignoreFilterExpression) {
