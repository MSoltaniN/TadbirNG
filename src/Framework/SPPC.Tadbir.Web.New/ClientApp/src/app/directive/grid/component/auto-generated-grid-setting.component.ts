...
export class AutoGeneratedGridSettingComponent extends BaseComponent implements OnInit, OnDestroy {
  ...
  @Input() public set entityTypeName(entityName: string) {
    ...
    this.currentSettings = this.settingService.getSettingByViewId(this.viewId);
  }
 ...
 */
  ...
  private loadSetting() {
    ...
    if (this.currentSettings)
      currentSetting = this.currentSettings;
    else
      currentSetting = this.settingService.getSettingByViewId(this.viewId);
