...
import { AutoGeneratedGridComponent, MetaDataService, GridService, BrowserStorageService, ViewName } from '@sppc/shared';
import { Currency, CurrencyService, CurrencyApi, CurrencyInfo } from '@sppc/finance';
