...
export class SystemIssueComponent extends AutoGeneratedGridComponent implements OnInit {
  ...
  handleSelection(event: any) {
    ...
    if (this.selectedSystemIssue.viewId && this.selectedSystemIssue.apiUrl) {
      ...
      this.getDataUrl = environment.BaseUrl + this.selectedSystemIssue.apiUrl + "?from=" + this.fromDate + "&to=" + this.toDate;;
      this.reloadGrid();
    }
    else {
  ...
  changeParam() {
    this.selectedSystemIssue = undefined;
    this.checkedIssues = [];
    this.selectedIssue = [];
    this.listTitle = undefined;
    this.isShowGrid = false;
