...
import { BranchScopeResource, VoucherStatusResource, AccountBookDisplayTypeResource, AccountBookDisplayType, ArticleTypesResourceKey, ArticleTypesResource, VoucherService, VoucherLineService, AccountBookApi, VoucherApi } from '@sppc/finance';
import { Item, MetaDataService, ReportingService, GridService, BrowserStorageService, ViewName, AccountBookPermissions, VoucherPermissions, SelectFormComponent, LookupApi } from '@sppc/shared';
