      ...
      if (this.groupOperation && !this.selectedContextmenu) {
        ...
        this.accountGroupService.groupDelete(url, this.selectedModelsIdArray).subscribe(res => {
          ...
          if (data && data.length > 0) {
            ...
            this.openErrorListDialog(data, this.selectedModelsIdArray.length);
            deleted = false;
          }
          else {
            this.showMessage(String.Format(this.getText("Messages.Deleted"), this.getText("Entity." + this.entityTypeName)), MessageType.Info);
          }
