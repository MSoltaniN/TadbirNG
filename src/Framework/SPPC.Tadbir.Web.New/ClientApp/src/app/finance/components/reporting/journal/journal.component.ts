...
import {
  Item, ViewIdentifierComponent, ReportViewerComponent, ReportManagementComponent, QuickReportSettingComponent,
  GridService, BrowserStorageService, MetaDataService, ReportingService, ViewName, JournalPermissions, VoucherPermissions
} from '@sppc/shared';
import { Layout, Entities, MessageType } from '@sppc/env/environment';
import {
  JournalDisplayTypeResource, VoucherStatusResource, BranchScopeResource, ArticleTypesResource, ArticleTypesResourceKey,
  VoucherLineService, VoucherService, VoucherApi, JournalType, JournalDisplayType, JournalApi
} from '@sppc/finance';
