...
export class CurrencyBookDetailComponent extends AutoGeneratedGridComponent implements OnInit {
  ...
  handleReportParams() {
    ...
    switch (this.voucherStatus) {
      case "2": {
        this.defaultFilter.push(new Filter("VoucherStatusId", this.voucherStatus, "== {0}", "System.Int32"));
        break;
      }
      case "3": {
        this.defaultFilter.push(new Filter("VoucherStatusId", this.voucherStatus, "== {0}", "System.Int32"));
    ...
    if (this.currencyId)
      this.defaultFilter.push(new Filter("CurrencyId", this.currencyId.toString(), "== {0}", "System.Int32"));
    else
      this.defaultFilter.push(new Filter("CurrencyId", "", "== null", ""));
