...
import { ProfitLossApi } from "@sppc/finance/service/api";
...
export class ProfitLostComponent extends AutoGeneratedGridComponent implements OnInit {
  ...
  validateFilters() {
    ...
    if (this.showFilterByRef) {
      if (!this.filterByRef) {
        this.showMessage(this.getText('ProfitLoss.FilterByRef'));
        isValid = false;
      }
    }
  ...
  getReportData() {
    ...
    if (startDate == endDate) {
      if (!this.comparativeSelected) {
        ...
        this.entityName = Entities.ComparativeProfitLossSimple;
        this.viewId = ViewName[this.entityTypeName];
    ...
    //not simple
      ...
      if (!this.comparativeSelected) {
        ...
        this.entityName = Entities.ComparativeProfitLoss;
        this.viewId = ViewName[this.entityTypeName];
    ...
    if (this.comparative.toString() != ComparativeKeys.Branch && this.branchScopeSelected == "1") {
    ...
    if (!this.comparativeSelected)
      ...
      this.reloadGrid(undefined, param);
    }
  }
