...
export class VoucherComponent extends AutoGeneratedGridComponent implements OnInit {
  ...
  addVoucherStatusFilter() {
    ...
    this.activeRoute.params.subscribe(params => {
      switch (params['mode']) {
        case "committed": {          
          this.quickFilter.push(new Filter("VoucherStatusId", "1", " < {0} ", "System.Int32"));
          this.voucherStatusTypeLabel = this.getText("Voucher.CommittedVouchers")
          this.voucherStatusTypeSelected = true;
          break;
        }
        case "finalized": {
          this.quickFilter.push(new Filter("VoucherStatusId", "2", " != {0} ", "System.Int32"));
          this.voucherStatusTypeLabel = this.getText("Voucher.FinalizedVouchers")
          this.voucherStatusTypeSelected = true;
          break;
        }
        case "confirmed": {
          this.quickFilter.push(new Filter("VoucherConfirmedById", "null", " == {0} ", "System.Int32"));
          this.voucherStatusTypeLabel = this.getText("Voucher.ConfirmedVouchers")
          this.voucherStatusTypeSelected = true;
          break;
        }
        case "approved": {
          this.quickFilter.push(new Filter("VoucherApprovedById", "null", " == {0} ", "System.Int32"));
          this.voucherStatusTypeLabel = this.getText("Voucher.ApprovedVouchers")
          this.voucherStatusTypeSelected = true;
          break;
        }
      }
