  ...
  */
  ...
  isDisabledConfirmGroupBtn = () => {
    if (this.selectedRows.length == 0)
      ...
      //---------کدام اسناد می توانند تایید گروهی شوند؟
      return false;
    } else {
      return true;
    }
  ...
  onUnFinalizedHandler() {
    console.log('onUnFinalizedHandler');
    if (this.groupOperation) {
    ...
    //}
    //else {
    //  console.log('درآینده نزدیک امکان برگشت از ثبت قطعی گروهی کامل می گردد');
    //}
