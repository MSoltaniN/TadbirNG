  ...
  onCheckHandler() {
    if (this.validateVoucherSelection()) {
      if (this.groupOperation) {
        //ثبت گروهی
        if (!this.validateMultiTypeSelection()) return;
        if (this.isNormalsOnlySelected() && !this.checkPermissions(false, true, Entities.Voucher, ManageVouchersPermissions.GroupCheck)) return;
        if (this.isDraftsOnlySelected() && !this.checkPermissions(true, false, Entities.DraftVoucher, ManageDraftVouchersPermissions.GroupCheck)) return;
  ...
  onUnCheckHandler() {
    if (this.validateVoucherSelection()) {
      if (this.groupOperation) {
        //برگشت سند گروهی
        if (!this.validateMultiTypeSelection()) return;
        if (this.isNormalsOnlySelected() && !this.checkPermissions(false, true, Entities.Voucher, ManageVouchersPermissions.GroupUndoCheck)) return;
        if (this.isDraftsOnlySelected() && !this.checkPermissions(true, false, Entities.DraftVoucher, ManageDraftVouchersPermissions.GroupUndoCheck)) return;
