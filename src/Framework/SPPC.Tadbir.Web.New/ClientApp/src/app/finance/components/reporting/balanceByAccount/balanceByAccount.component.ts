...
import { TestBalanceOptions } from '@sppc/finance/enum/balance';
...
export class BalanceByAccountComponent extends AutoGeneratedGridComponent implements OnInit {
  ...
  generateOptionNumber() {
    var options = (this.showTemporaryVoucher ? TestBalanceOptions.UseClosingTempVoucher : 0) |
      (this.showClosingVoucher ? TestBalanceOptions.UseClosingVoucher : 0) |
