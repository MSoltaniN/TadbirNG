...
export class TestBalanceComponent extends AutoGeneratedGridComponent implements OnInit {
  ...
  constructor(public toastrService: ToastrService, public translate: TranslateService, public dialogService: DialogService, public gridService: GridService,
    ...
    , public testBalanceService: TestBalanceService, public lookupService: LookupService) {
  ...
  getReportData(accountId?: any, clearbreadCrumb: boolean = true) {
    ...
    if (this.selectedReferences && this.selectedReferences.length > 0) {
      ...
      var lastItem = this.selectedReferences[this.referenceValues.length - 1];
      this.selectedReferences.forEach((item) => {
        var refFilter = new Filter("VoucherReference", item, " == {0}", "System.String");
        referencesFilter = this.addFilterExpressionWithBrace(referencesFilter, refFilter, item === lastItem);
      });
