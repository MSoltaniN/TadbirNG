...
export class TestBalanceComponent extends AutoGeneratedGridComponent implements OnInit, OnDestroy {
  ...
  openSelectForm() {
    ...
    if (!this.isAccess(Entities.TestBalance, TestBalancePermissions.Lookup) || !this.isAccess(Entities.Account, AccountPermissions.View)) {      
      this.showMessage(this.getText('App.AccessDenied'), MessageType.Warning);
      return;
    }
  ...
  getReportData(accountId?:any,clearbreadCrumb:boolean = true) {    
    ...
    if (this.showFilterByRef) {
      ...
      if (this.filterByRef) {
        ...
        this.defaultFilter.push(new Filter("VoucherReference", filterByRefValue, "== {0}", "System.String"));
      }
      else {
        this.defaultFilter.push(new Filter("VoucherReference", filterByRefValue, "== null", "System.String"));        
      }
    }
