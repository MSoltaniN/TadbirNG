...
export class TestBalanceComponent extends AutoGeneratedGridComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.settingService.getSettingById(SettingKey.TestBalanceConfig).subscribe(function (res) {
      if (res) {        
        this.addOpeningVoucherToInitBalance = res.values.addOpeningVoucherToInitBalance;
      }
    });
