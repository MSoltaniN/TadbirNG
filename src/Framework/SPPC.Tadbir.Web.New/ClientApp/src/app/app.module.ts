...
import { SppcAutoGridFilter } from './controls/grid/sppc-auto-grid-filter';
...
import { SppcPermissionCheckDirective } from './directive/sppc-permissionCheck';
...
@NgModule({
  ...
  entryComponents: [
    ...
    TabComponent, AccountGroupsFormComponent, VoucherEditorComponent, SelectFormComponent, CurrencyFormComponent, BranchFormComponent, BranchRolesFormComponent
  ],
