...
export class SelectFormComponent extends AutoGeneratedGridComponent implements OnInit {
  ...
  getCurrentSetting(event: QuickSearchConfig) {
    ...
    var entity = this.baseEntitiesList.find(f => f.key == parseInt(this.selectedEntity));
    this.title = String.Format(this.getText('SelectForm.EntityTitle'), entity.value, serchededItem.join(', '))
  }
