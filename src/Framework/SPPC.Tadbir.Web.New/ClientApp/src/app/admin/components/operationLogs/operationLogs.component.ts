...
import { DefaultComponent, Filter, FilterExpressionOperator } from '@sppc/shared/class';
...
export class OperationLogsComponent extends AutoGeneratedGridComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.useOrFilterExpression = true;
    this.loadStates();
  ...
  getReportData() {
    ...
    if (this.companySelected != "-1") {
      ...
      this.orDefaultFilter = new Filter("CompanyId", this.companySelected.toString(), " == null", "System.Int32");
    }
    ...
    //  currentFilter = this.addFilterToFilterExpression(currentFilter,
    //    orFilter, FilterExpressionOperator.Or);
    ...
    //this.ignoreFilterExpression = false;
  }
