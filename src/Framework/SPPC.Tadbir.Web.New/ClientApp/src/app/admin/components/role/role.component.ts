...
import { Role, RelatedItemsInfo, RoleDetailsInfo, RoleService, RoleFull, RoleApi, RoleInfo } from '@sppc/admin';
import { Permission } from '@sppc/core';
import { GridService, MetaDataService, BrowserStorageService, ViewName, RelatedItems } from '@sppc/shared';
