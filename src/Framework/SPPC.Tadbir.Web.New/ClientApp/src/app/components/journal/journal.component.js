...
var journal_1 = require("../../enum/journal");
...
var JournalComponent = /** @class */ (function (_super) {
    ...
    function JournalComponent(toastrService, translate, dialogService, gridService, cdref, renderer, metadata, settingService) {
        ...
        _this.displayType = [
            { value: journal_1.JournalDisplayTypeResource.VoucherRows, key: "1" },
            { value: journal_1.JournalDisplayTypeResource.VoucherRowsWithFloatingAccounts, key: "2" },
            { value: journal_1.JournalDisplayTypeResource.LedgerLevel, key: "3" },
            { value: journal_1.JournalDisplayTypeResource.SubsidiaryLevel, key: "4" },
            { value: journal_1.JournalDisplayTypeResource.BriefVoucher, key: "5" },
            { value: journal_1.JournalDisplayTypeResource.BriefVoucherByDate, key: "6" },
            { value: journal_1.JournalDisplayTypeResource.BriefVoucherByMonth, key: "7" },
        ];
        _this.voucherStatus = [
            { value: journal_1.VoucherStatusResource.Committed, key: "2" },
            { value: journal_1.VoucherStatusResource.Finalized, key: "3" },
            { value: journal_1.VoucherStatusResource.Accepted, key: "4" },
            { value: journal_1.VoucherStatusResource.Approved, key: "5" },
            { value: journal_1.VoucherStatusResource.AllVouchers, key: "0" }
        ];
        _this.branchScope = [
            { value: journal_1.BranchScopeResource.CurrentBranch, key: "1" },
            { value: journal_1.BranchScopeResource.CurrentBranchAndSubsets, key: "2" },
        ];
        _this.articleType = [
            { value: journal_1.ArticleTypesResource.AllVoucherLines, key: "1" },
            { value: journal_1.ArticleTypesResource.MarkedVoucherLines, key: "2" },
            { value: journal_1.ArticleTypesResource.UncheckedVoucherLines, key: "3" },
        ];
        ...
        if (this.journalType) {
            ...
            if (this.journalType == journal_1.JournalType.ByDate && this.fromDate && this.toDate) {
                switch (parseInt(this.displayTypeSelected)) {
                    case journal_1.JournalDisplayType.ByDateByRow:
                        {
                            this.entityTypeName = environment_1.Entities.JournalByDateByRow;
                            this.metadataType = environment_1.Metadatas.JournalByDateByRow;
                    ...
                    case journal_1.JournalDisplayType.ByDateByRowDetail:
                        {
                    ...
                    case journal_1.JournalDisplayType.ByDateByLedger:
                        {
                    ...
                    case journal_1.JournalDisplayType.ByDateBySubsidiary:
                        {
                    ...
                    case journal_1.JournalDisplayType.ByDateLedgerSummary:
                        {
                    ...
                    case journal_1.JournalDisplayType.ByDateLedgerSummaryByDate:
                        {
                    ...
                    case journal_1.JournalDisplayType.ByDateLedgerSummaryByMonth:
                        {
                            this.getDataUrl = "";
                            break;
                        }
            ...
            if (this.journalType == journal_1.JournalType.ByVoucher) {
