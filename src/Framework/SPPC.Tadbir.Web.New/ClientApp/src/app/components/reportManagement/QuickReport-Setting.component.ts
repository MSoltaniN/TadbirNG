...
import { Component, OnInit, Renderer2, NgZone, ChangeDetectorRef, ViewEncapsulation, ViewChild } from '@angular/core';
...
export class QuickReportSettingComponent extends AutoGeneratedGridComponent implements OnInit {
  ...
  createSettingFromBaseGrid(gridColumns: Property[], viwId: number) {
    ...
    var jsonString = localStorage.getItem("s" + this.currentViewId.toString());
  ...
  showReport() {
    ...
    var viwString = JSON.stringify(this.viewInfo);
    localStorage.setItem("s" + this.currentViewId.toString(), viwString);
    //temp save viw info in localstoreage
