    ...
    switchReport(showQReport : boolean,treeData : any,defReport:any)
    {
      ...
      {               
        ...
        this.reportingService.getAll(url).subscribe((res: Response) => {
          ...
          if (printInfo.parameters.length > 0)
          {
            viewInfo.parameters = printInfo.parameters;
            //params.forEach(function (param) {
            //  var index = viewInfo.parameters.findIndex(f => f.name === param.ParamName);
            //  viewInfo.parameters[index].value = param.ParamValue; 
            //});
          }
