...
export class AccountBookComponent extends AutoGeneratedGridComponent implements OnInit, OnDestroy {
        ...
        switch (this.selectedViewId) {
          case ViewName.Account: {
            ...
            switch (parseInt(this.displayTypeSelected)) {
              case AccountBookDisplayType.ByRow: {
                ...
                this.getDataUrl = this.selectedBranchSeparation ? '' : AccountBookApi.AccountBookByRow;
                break
              }
              case AccountBookDisplayType.VoucherSum: {
                this.entityName = Entities.AccountBookSingleSummary;
                this.getDataUrl = this.selectedBranchSeparation ? '' : AccountBookApi.AccountBookVoucherSum;
                break
              }
              case AccountBookDisplayType.DailySum: {
                this.entityName = Entities.AccountBookSummary;
                this.getDataUrl = this.selectedBranchSeparation ? '' : AccountBookApi.AccountBookDailySum;
                break
              }
              case AccountBookDisplayType.MonthlySum: {
                this.entityName = Entities.AccountBookSummary;
                this.getDataUrl = this.selectedBranchSeparation ? '' : AccountBookApi.AccountBookMonthlySum;
                break
              }
              default:
            }
          ...
          case ViewName.DetailAccount: {
            ...
            switch (parseInt(this.displayTypeSelected)) {
              case AccountBookDisplayType.ByRow: {
                this.entityName = Entities.AccountBookSingle;
                this.getDataUrl = this.selectedBranchSeparation ? '' : AccountBookApi.DetailAccountBookByRow;
                break
              }
              case AccountBookDisplayType.VoucherSum: {
                this.entityName = Entities.AccountBookSingleSummary;
                this.getDataUrl = this.selectedBranchSeparation ? '' : AccountBookApi.DetailAccountBookVoucherSum;
                break
              }
              case AccountBookDisplayType.DailySum: {
                this.entityName = Entities.AccountBookSummary;
                this.getDataUrl = this.selectedBranchSeparation ? '' : AccountBookApi.DetailAccountBookDailySum;
                break
              }
              case AccountBookDisplayType.MonthlySum: {
                this.entityName = Entities.AccountBookSummary;
                this.getDataUrl = this.selectedBranchSeparation ? '' : AccountBookApi.DetailAccountBookMonthlySum;
                break
              }
              default:
            }
          ...
          case ViewName.CostCenter: {
            ...
            switch (parseInt(this.displayTypeSelected)) {
              case AccountBookDisplayType.ByRow: {
                this.entityName = Entities.AccountBookSingle;
                this.getDataUrl = this.selectedBranchSeparation ? '' : AccountBookApi.CostCenterBookByRow;
                break
              }
              case AccountBookDisplayType.VoucherSum: {
                this.entityName = Entities.AccountBookSingleSummary;
                this.getDataUrl = this.selectedBranchSeparation ? '' : AccountBookApi.CostCenterBookVoucherSum;
                break
              }
              case AccountBookDisplayType.DailySum: {
                this.entityName = Entities.AccountBookSummary;
                this.getDataUrl = this.selectedBranchSeparation ? '' : AccountBookApi.CostCenterBookDailySum;
                break
              }
              case AccountBookDisplayType.MonthlySum: {
                this.entityName = Entities.AccountBookSummary;
                this.getDataUrl = this.selectedBranchSeparation ? '' : AccountBookApi.CostCenterBookMonthlySum;
                break
              }
              default:
            }
          ...
          case ViewName.Project: {
            ...
            switch (parseInt(this.displayTypeSelected)) {
              case AccountBookDisplayType.ByRow: {
                this.entityName = Entities.AccountBookSingle;
                this.getDataUrl = this.selectedBranchSeparation ? '' : AccountBookApi.ProjectBookByRow;
                break
              }
              case AccountBookDisplayType.VoucherSum: {
                this.entityName = Entities.AccountBookSingleSummary;
                this.getDataUrl = this.selectedBranchSeparation ? '' : AccountBookApi.ProjectBookVoucherSum;
                break
              }
              case AccountBookDisplayType.DailySum: {
                this.entityName = Entities.AccountBookSummary;
                this.getDataUrl = this.selectedBranchSeparation ? '' : AccountBookApi.ProjectBookDailySum;
                break
              }
              case AccountBookDisplayType.MonthlySum: {
                this.entityName = Entities.AccountBookSummary;
                this.getDataUrl = this.selectedBranchSeparation ? '' : AccountBookApi.ProjectBookMonthlySum;
                break
              }
              default:
            }
  ...
  onCellClick({ rowIndex, column, dataItem, isEdited }) {
    ...
    if (isEdited || (this.formGroup && !this.formGroup.valid) || (column.field != 'mark' && this.editedRowIndex == rowIndex) || dataItem.voucherNo == 0) {
      return;
    }
