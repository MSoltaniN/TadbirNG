...
export class ReportViewerComponent extends DefaultComponent implements OnInit {
  ...
  constructor(public toastrService: ToastrService, public translate: TranslateService,
   ...
   private voucherService: VoucherService, public renderer: Renderer2,
    public metadata: MetaDataService, public settingService: SettingService,private http: Http) {
  ...
  showVoucherReport(url : string , reportData: any)
  {
    ...
    this.http.request(url).subscribe((data:any) => {
      ...
      Stimulsoft.Base.Localization.StiLocalization.setLocalizationFile("reports/localization/fa.xml");
