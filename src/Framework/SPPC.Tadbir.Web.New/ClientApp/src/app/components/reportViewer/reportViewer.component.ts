...
export class ReportViewerComponent extends DefaultComponent implements OnInit {
  ...
  constructor(public toastrService: ToastrService, public translate: TranslateService,
   ...
   private voucherService: VoucherService, public renderer: Renderer2,
    public metadata: MetaDataService, public settingService: SettingService,private http: HttpClient) {
  ...
  showVoucherReport(url : string , reportData: any)
  {
    //url
    //this.rowData.data
    this.active = true;

    this.http.get(url,this.voucherService.option).subscribe((data:any) => {
  ...
  showVoucherStdFormReport(url : string , reportData: any)
  {
    //url
    //this.rowData.data
    this.active = true;
    var options = { headers: this.voucherService.httpHeaders, observe: "response"};
    this.http.get(url, this.voucherService.option ).subscribe((data:any) => {
