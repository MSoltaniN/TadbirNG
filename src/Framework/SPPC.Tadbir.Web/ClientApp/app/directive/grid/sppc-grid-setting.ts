...
import { GridSettingFormComponent } from "./component/grid-setting-form.component";


@Directive({
    selector: '[sppc-grid-setting]',        
    providers: [DefaultComponent, String,GridSettingFormComponent]
})
...
export class SppcGridSetting {
    ...
    constructor(private elRef: ElementRef, private translate: TranslateService, @Host() private setting: GridSettingFormComponent,
