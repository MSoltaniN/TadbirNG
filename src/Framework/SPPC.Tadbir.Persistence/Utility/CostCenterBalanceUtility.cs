...
{
    internal class CostCenterBalanceUtility : ReportUtilityBase, ITestBalanceUtility
    {
        public CostCenterBalanceUtility(IConfigRepository config, IDomainMapper mapper)
            : base(config, mapper)
        {
        }
