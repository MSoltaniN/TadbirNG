...
namespace SPPC.Tadbir.Configuration
{
    ...
    public class TadbirConfigurationSection : ConfigurationSection
    {
        ...
        /// <summary>
        /// Gets workflow configuration settings in Tadbir application
        /// </summary>
        [ConfigurationProperty("workflowSettings")]
        public WorkflowSettingsElement WorkflowSettings
        {
            get
            {
                return (WorkflowSettingsElement)base["workflowSettings"];
            }
        }
