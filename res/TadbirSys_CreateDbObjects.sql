...
INSERT [Metadata].[ShortcutCommand] ([ShortcutCommandID], [PermissionID], [Name], [Scope], [HotKey], [Method], [rowguid], [ModifiedDate]) VALUES (1, NULL, N'NewVoucherLine', N'VoucherLineComponent', N'Ctrl+O', N'sh_addNew')

INSERT [Metadata].[ShortcutCommand] ([ShortcutCommandID], [PermissionID], [Name], [Scope], [HotKey], [Method], [rowguid], [ModifiedDate]) VALUES (2, NULL, N'ExportToExcel', N'AutoGeneratedGridComponent,AutoGridExplorerComponent', N'Alt+E', N'sh_exportToExcel')

INSERT [Metadata].[ShortcutCommand] ([ShortcutCommandID], [PermissionID], [Name], [Scope], [HotKey], [Method], [rowguid], [ModifiedDate]) VALUES (3, NULL, N'Print', N'AutoGeneratedGridComponent,AutoGridExplorerComponent,DetailComponent', N'Alt+P', N'sh_print')

INSERT [Metadata].[ShortcutCommand] ([ShortcutCommandID], [PermissionID], [Name], [Scope], [HotKey], [Method], [rowguid], [ModifiedDate]) VALUES (4, NULL, N'ReportSetting', N'AutoGeneratedGridComponent,AutoGridExplorerComponent', N'Alt+S', N'sh_openReportSetting')

INSERT [Metadata].[ShortcutCommand] ([ShortcutCommandID], [PermissionID], [Name], [Scope], [HotKey], [Method], [rowguid], [ModifiedDate]) VALUES (5, NULL, N'AdvanceFilter', N'AutoGeneratedGridComponent,AutoGridExplorerComponent', N'Alt+L', N'sh_openAdvanceFilter')

INSERT [Metadata].[ShortcutCommand] ([ShortcutCommandID], [PermissionID], [Name], [Scope], [HotKey], [Method], [rowguid], [ModifiedDate]) VALUES (9, NULL, N'NewRecord', N'AutoGeneratedGridComponent,AutoGridExplorerComponent', N'Ctrl+Alt+N', N'sh_openNewDialog')

INSERT [Metadata].[ShortcutCommand] ([ShortcutCommandID], [PermissionID], [Name], [Scope], [HotKey], [Method], [rowguid], [ModifiedDate]) VALUES (13, NULL, N'EditRecord', N'AutoGeneratedGridComponent,AutoGridExplorerComponent', N'Ctrl+Alt+M', N'sh_openEditDialog')

INSERT [Metadata].[ShortcutCommand] ([ShortcutCommandID], [PermissionID], [Name], [Scope], [HotKey], [Method], [rowguid], [ModifiedDate]) VALUES (14, NULL, N'DeleteRecord', N'AutoGeneratedGridComponent,AutoGridExplorerComponent', N'Ctrl+Alt+D', N'sh_delete')

INSERT [Metadata].[ShortcutCommand] ([ShortcutCommandID], [PermissionID], [Name], [Scope], [HotKey], [Method], [rowguid], [ModifiedDate]) VALUES (18, NULL, N'ExecuteFilter', N'AutoGeneratedGridComponent,AutoGridExplorerComponent', N'Ctrl+Alt+L', N'sh_executeFilter')

INSERT [Metadata].[ShortcutCommand] ([ShortcutCommandID], [PermissionID], [Name], [Scope], [HotKey], [Method], [rowguid], [ModifiedDate]) VALUES (20, NULL, N'NewVoucher', N'VoucherEditorComponent', N'Alt+Insert', N'sh_newVoucher')

INSERT [Metadata].[ShortcutCommand] ([ShortcutCommandID], [PermissionID], [Name], [Scope], [HotKey], [Method], [rowguid], [ModifiedDate]) VALUES (21, NULL, N'RemoveVoucher', N'VoucherEditorComponent', N'Alt+Delete', N'sh_removeVoucher')

INSERT [Metadata].[ShortcutCommand] ([ShortcutCommandID], [PermissionID], [Name], [Scope], [HotKey], [Method], [rowguid], [ModifiedDate]) VALUES (22, NULL, N'CheckVoucher', N'VoucherEditorComponent', N'Alt+S', N'sh_checkVoucher')

INSERT [Metadata].[ShortcutCommand] ([ShortcutCommandID], [PermissionID], [Name], [Scope], [HotKey], [Method], [rowguid], [ModifiedDate]) VALUES (23, NULL, N'UnCheckVoucher', N'VoucherEditorComponent', N'Alt+K', N'sh_unCheckVoucher')

INSERT [Metadata].[ShortcutCommand] ([ShortcutCommandID], [PermissionID], [Name], [Scope], [HotKey], [Method], [rowguid], [ModifiedDate]) VALUES (24, NULL, N'ReportManagement', N'NavMenuComponent,AutoGeneratedGridComponent,AutoGridExplorerComponent', N'Alt+Q', N'sh_openReportManager')
