...
INSERT INTO [Finance].[Account] (AccountID, FiscalPeriodID, Code, Name) VALUES (4, 1, N'110', N'حساب شماره 220-800-123456-4 بانک پاسارگاد شعبه میدان ولی عصر تهران')
INSERT INTO [Finance].[Account] (AccountID, FiscalPeriodID, Code, Name) VALUES (5, 1, N'120', N'موجودی نقدی - صندوق')
INSERT INTO [Finance].[Account] (AccountID, FiscalPeriodID, Code, Name) VALUES (6, 1, N'400', N'سرمایه')
INSERT INTO [Finance].[Account] (AccountID, FiscalPeriodID, Code, Name) VALUES (7, 1, N'200', N'اثاثه و منصوبات اداری')
SET IDENTITY_INSERT [Finance].[Account] OFF

SET IDENTITY_INSERT [Auth].[User] ON
INSERT INTO [Auth].[User] (UserID) VALUES (1)
...
INSERT INTO [Finance].[Transaction] (TransactionID, FiscalPeriodID, CreatorID, ModifierID, [No], [Date], [Description], [Status], IsVerified, IsApproved)
  VALUES (1, 1, 1, 1, N'1', N'2017-02-14', N'سند اولیه تاسیس', N'ثبت نشده', 0, 0)
INSERT INTO [Finance].[Transaction] (TransactionID, FiscalPeriodID, CreatorID, ModifierID, [No], [Date], [Description], [Status], IsVerified, IsApproved)
  VALUES (2, 1, 1, 1, N'2', N'2017-02-17', N'خرید نقدی لوازم اداری', N'ثبت نشده', 0, 0)
SET IDENTITY_INSERT [Finance].[Transaction] OFF

SET IDENTITY_INSERT [Finance].[TransactionLine] ON
INSERT INTO [Finance].[TransactionLine] (LineID, TransactionID, AccountID, CurrencyID, [Description], Debit, Credit)
  VALUES (1, 1, 4, 1, N'ثبت موجودی نقدی اولیه در حساب بانکی', 100000000, 0)
INSERT INTO [Finance].[TransactionLine] (LineID, TransactionID, AccountID, CurrencyID, [Description], Debit, Credit)
  VALUES (2, 1, 5, 1, N'ثبت موجودی نقدی اولیه صندوق', 5000000, 0)
INSERT INTO [Finance].[TransactionLine] (LineID, TransactionID, AccountID, CurrencyID, [Description], Debit, Credit)
  VALUES (3, 1, 6, 1, N'ثبت سرمایه اولیه', 0, 105000000)
INSERT INTO [Finance].[TransactionLine] (LineID, TransactionID, AccountID, CurrencyID, [Description], Debit, Credit)
  VALUES (4, 2, 5, 1, N'خرید نقدی لوازم اداری مصرفی', 850000, 0)
INSERT INTO [Finance].[TransactionLine] (LineID, TransactionID, AccountID, CurrencyID, [Description], Debit, Credit)
  VALUES (5, 2, 7, 1, N'خرید نقدی لوازم اداری مصرفی', 0, 850000)
